...
public class RobotContainer {
  ...
  private final MoveAndShoot m_moveAndShoot = new MoveAndShoot(m_driveTrain, m_shooter, m_indexer);
  ...
  private void setDefaultCommands() {
    ...
    m_driveTrain.setDefaultCommand(
      new TankDrive(
        () -> -1 * m_controller0.getLeftStickY(), 
        () -> -1 * m_controller0.getRightStickY(), m_driveTrain)
        // Inverted because XboxController reads upward joystick as negative
